...
<br>
<?=HTML_UTIL::hidden("action","save")?>
<?=HTML_UTIL::button("save","Save Settings",array("type"=>"button","class"=>"btn btn-primary","id"=>"button-save"))?>

<script>

	$(function() {

      	$("#button-save").go("<?=$current?>",{ data: "form", success: function(response) {
        	FF.msg.success("Saved settings");
    	}});
