...
class RefundTransactionRequestType extends AbstractRequestType
{
     ...
     * transaction. This will allow us to make sure we do not double refund.
     */
    var $RefundAdvice;

    var $MerchantStoreDetails;

    var $RefundItemDetails;
    ...
    function getRefundAdvice()
    {
        return $this->RefundAdvice;
    }
    function setRefundAdvice($RefundAdvice, $charset = 'iso-8859-1')
    {
        $this->RefundAdvice = $RefundAdvice;
        $this->_elements['RefundAdvice']['charset'] = $charset;
    }
    ...
    function getRefundItemDetails()
    {
        return $this->RefundItemDetails;
    }
    function setRefundItemDetails($RefundItemDetails, $charset = 'iso-8859-1')
    {
        $this->RefundItemDetails = $RefundItemDetails;
        $this->_elements['RefundItemDetails']['charset'] = $charset;
    }
}
