...
class PaymentTransactionType extends XSDSimpleType
{
    ...
    function getOfferCouponInfo()
    {
        return $this->OfferCouponInfo;
    }
    function setOfferCouponInfo($OfferCouponInfo, $charset = 'iso-8859-1')
    {
        $this->OfferCouponInfo = $OfferCouponInfo;
        $this->_elements['OfferCouponInfo']['charset'] = $charset;
    }
