...
class TransactionSearchRequestType extends AbstractRequestType
{
    ...
    /**
     * Search by Store Id. It is mandatory field if Terminal Id is specified as one of
     * the search parameters.
     */
    var $StoreID;

    /**
     * Search by Store Id and Terminal Id. If the Terminal Id field is specified as one
     * of the search parameters, then there should be a valid Store Id value set in the
     * StoreID field.
     */
    var $TerminalID;
