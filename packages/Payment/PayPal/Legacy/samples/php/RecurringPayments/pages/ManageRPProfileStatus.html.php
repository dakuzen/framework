...
$details = $response->ManageRecurringPaymentsProfileStatusResponseDetails;

?>
<html>
<head>
<title>PayPal PHP SDK - ManageRecurringPaymentsProfileStatus API</title>
...
<table width=400>
	<?php 
    	...
    	foreach($response as $key => $value) {
    		...
    		if($key[0] != '_' && $value != null && $key != 'ManageRecurringPaymentsProfileStatusResponseDetails')
		   		echo "<tr><td>$key:</td><td>$value</td>";
    	}		
    ?>
    <tr>
