...
class CallerServices {
	...
	private function setApiKeys($username, $password, $signature)
	{
		$this->API_USERNAME = trim($username);
		$this->API_PASSWORD = trim($password);
		$this->API_SIGNATURE = trim($signature);
	}
	...
	{
		$this->setApiKeys($username, $password, $signature);		
	}
   	...
   	function call($request,$serviceName) {
		...
		try {
		    ...
		    $response = call($request, $endpoint, $this->sandBoxEmailAddress, $this->API_USERNAME, $this->API_PASSWORD, $this->API_SIGNATURE);
		    $isFault = false;
...
function call($MsgStr, $endpoint, $sandboxEmailAddress = '', $api_username, $api_password, $api_signature)
{
    ...
    $headers_array = setupHeaders(API_AUTHENTICATION_MODE, $api_username, $api_password, $api_signature);
...
function setupHeaders($auth_mode, $api_username, $api_password, $api_signature) {
    $headers_arr = array();
