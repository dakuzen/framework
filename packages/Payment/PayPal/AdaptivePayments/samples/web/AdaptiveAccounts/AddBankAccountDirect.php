...
/********************************************
AddBankAccountDirect.php

Called by index.html
Calls  AddBankAccountDirectReceipt.php,and APIError.php.
********************************************/
...
<div id="request_form">
    ...
    <form id="Form1" name="Form1"method="post" action="AddBankAccountDirectReceipt.php">

 
        <h3>Add Bank Account - Direct</h3>
  ...
  <tr>
    ...
    <tr>
        ...
        <td><input type="text" size="30" maxlength="50" name="createAccKey"
            value="" /></td>
    </tr>
