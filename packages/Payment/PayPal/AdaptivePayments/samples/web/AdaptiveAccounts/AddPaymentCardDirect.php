...
<div id="request_form">
    ...
    <form id="Form1" action="AddPaymentCardDirectReceipt.php" name ="AddPaymentCardForm">
<center>
  ...
  <tr>
     ...
     <tr>
        ...
        <td><input type="text" size="30" maxlength="16" name="cardNumber"
            value="" /></td>
    </tr>
	...
	<tr>
        ...
        <td><input type="text" size="30" maxlength="32"
            name="cardVerificationNumber" value="956" /></td>
    </tr>
    <tr>
     ...
     <tr>
        <td class="field">Create Account Key:</td>
        <td><input type="text" size="30" maxlength="32"
  ...
  <tr>
	...
	<tr>
		...
		<td class="thinfield" align=left><input type=text size=10 maxlength=10 name=zip value=95131>(5 or 9 digits)</td>
	</tr>
	<tr>
