...
<div id="request_form">
    <h3>GetPaymentDetails</h3>
     <br><br>
    <form id="Form1" name="Form1"  action="PaymentDetails.php?cs=s" method="post">
        <table align="center">
            <tr>
                <td class="thinfield2">
                    PayKey:
                ...
                <td>
                    <input type="text" name="payKey" value="<?php if(isset($_GET['payKey']))echo $_GET['payKey'];?>" />
                    </td>
            </tr>
           <tr>
	<td>
